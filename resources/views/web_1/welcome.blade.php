        ...
        <div class="container">
            <div class="site-header-inner">
                <div class="brand header-brand">
                    <h1 class="m-0">
                        <a href="#">
                            <img class="header-logo-image asset-light" src="{{asset('vendor/switch/images/logo-light.svg')}}" alt="Logo">
                            <img class="header-logo-image asset-dark" src="{{asset('vendor/switch/images/logo-dark.svg')}}" alt="Logo">
                        </a>
                    </h1>
                </div>
            </div>
        ...
        <section class="hero">
            <div class="container">
                <div class="hero-inner">
                    <div class="hero-copy">
                        <h1 class="hero-title mt-0">Keep track of what you want</h1>
                        ...
                        <div class="hero-cta">
                            <a class="button button-primary" href="{{route('login')}}">Start Now Free</a>
